...
shexDoc -> '$empty' : [] .
shexDoc -> directives notStartAction statements : ['$1'] .
shexDoc -> directives startActions statements : ['$1'] .
shexDoc -> directives notStartAction : ['$1'] .
shexDoc -> directives startActions : ['$1'] .
shexDoc -> directives : ['$1'] .
shexDoc -> notStartAction statements : ['$1'] .
shexDoc -> startActions statements : ['$1'] .
shexDoc -> notStartAction : ['$1'] .
shexDoc -> startActions : ['$1'] .
...
shapeExprDecl -> shapeExprLabel 'EXTERNAL' : {shape_expr_decl, '$2', external} .
...
shapeNot -> 'NOT' shapeAtom : {shape_not, '$1'} .

inlineShapeNot -> inlineShapeAtom : '$1' .
inlineShapeNot -> 'NOT' inlineShapeAtom : {shape_not, '$1'} .
...
shapeRef -> at_prefix_ln : '$1' .
shapeRef -> at_prefix_ns : '$1' .
shapeRef -> '@' shapeExprLabel : '$1' .

litNodeConstraint -> 'LITERAL' xsFacets .
litNodeConstraint -> 'LITERAL' .
litNodeConstraint ->  datatype  .
litNodeConstraint ->  datatype xsFacets .
litNodeConstraint ->  valueSet .
litNodeConstraint ->  valueSet xsFacets .
litNodeConstraint ->  numericFacets .

nonLitNodeConstraint -> nonLiteralKind .
nonLitNodeConstraint -> nonLiteralKind stringFacets .
nonLitNodeConstraint -> stringFacets .
...
stringFacet -> regexp               : {string_facet, regexp, {'$1'}} .
...
multiElementOneOf -> groupTripleExpr groupTripleExprSeq .
...
singleElementGroup -> unaryTripleExpr     : '$1' .
multiElementGroup  -> unaryTripleExpr unaryTripleExprSeq .

unaryTripleExprSeq -> ';' unaryTripleExpr ';' : ['$2'] .
unaryTripleExprSeq -> ';' unaryTripleExpr : ['$2'] .
unaryTripleExprSeq -> ';' unaryTripleExpr unaryTripleExprSeq : ['$2' | '$3'] .

unaryTripleExpr -> '$' tripleExprLabel tripleConstraint .
unaryTripleExpr -> '$' tripleExprLabel bracketedTripleExpr .
unaryTripleExpr -> tripleConstraint .
unaryTripleExpr -> bracketedTripleExpr .
unaryTripleExpr -> include : '$1' .
bracketedTripleExpr -> '(' tripleExpression ')' cardinality annotations semanticActions .
bracketedTripleExpr -> '(' tripleExpression ')' annotations semanticActions .
bracketedTripleExpr -> '(' tripleExpression ')' cardinality semanticActions .
bracketedTripleExpr -> '(' tripleExpression ')' semanticActions .

tripleConstraint -> senseFlags predicate inlineShapeExpression cardinality annotations semanticActions : {tripleConstraint, '$1', '$2', '$3', '$4', '$5', '$6'} .
tripleConstraint -> senseFlags predicate inlineShapeExpression annotations semanticActions						 : {tripleConstraint, '$1', '$2', '$3', nil , '$4', '$5'} .
tripleConstraint -> predicate inlineShapeExpression cardinality annotations semanticActions						 : {tripleConstraint, nil , '$1', '$2', '$3', '$4', '$5'} .
tripleConstraint -> predicate inlineShapeExpression annotations semanticActions												 : {tripleConstraint, nil , '$1', '$2', nil , '$3', '$4'} .
tripleConstraint -> senseFlags predicate inlineShapeExpression cardinality semanticActions						 : {tripleConstraint, '$1', '$2', '$3', '$4', nil , '$5'} .
tripleConstraint -> senseFlags predicate inlineShapeExpression semanticActions												 : {tripleConstraint, '$1', '$2', '$3', nil , nil , '$4'} .
tripleConstraint -> predicate inlineShapeExpression cardinality semanticActions												 : {tripleConstraint, nil , '$1', '$2', '$3', nil , '$4'} .
tripleConstraint -> predicate inlineShapeExpression semanticActions																		 : {tripleConstraint, nil , '$1', '$2', nil , nil , '$3'} .
...
valueSet -> '[' valueSetValues ']' : {value_set, '$1'} .
valueSet -> '[' ']'                : {value_set, []} .
...
valueSetValue -> '.' iriExclusions : '$2' .
valueSetValue -> '.' literalExclusions : '$2' .
valueSetValue -> '.' languageExclusions : '$2' .

iriRange -> iri '~' iriExclusions : {iri_range, '$1', '$2', '$3'} .
iriRange -> iri '~'						    : {iri_range, '$1', '$2', nil } .
iriRange -> iri								    : {iri_range, '$1', nil , nil } .

iriExclusions -> iriExclusion : ['$1'] .
iriExclusions -> iriExclusion iriExclusions : ['$1' | '$2'] .
iriExclusion -> '-' iri '~' : {iri_exclusion, '$2', '$3'} .
iriExclusion -> '-' iri			: {iri_exclusion, '$2', nil } .

literalRange -> literal '~' literalExclusions : {literal_range, '$1', '$2', '$3'} .
literalRange -> literal '~'						        : {literal_range, '$1', '$2', nil } .
...
literalExclusion -> '-' literal '~' : {literal_exclusion, '$2', '$3'} .
literalExclusion -> '-' literal     : {literal_exclusion, '$2', nil } .

languageRange -> langtag '~' languageExclusions : {language_range, '$1', '$2', '$3'} .
languageRange -> langtag '~'										: {language_range, '$1', '$2', nil } .
languageRange -> langtag 												: {language_range, '$1', nil , nil } .
languageRange -> '@' '~' languageExclusions 		: {language_range, '$1', '$2', '$3'} .
languageRange -> '@' '~' 												: {language_range, '$1', '$2', nil } .

languageExclusions -> languageExclusion : ['$1'] .
languageExclusions -> languageExclusion languageExclusions : ['$1' | '$2'] .
languageExclusion -> '-' langtag '~' : {language_exclusion, '$2', '$3'} .
...
semanticActions -> '$empty' .
semanticActions -> codeDecls .
codeDecls -> codeDecl : ['$1'] .
codeDecls -> codeDecl codeDecls : ['$1' | '$2'] .
codeDecl -> '%' iri code : {code, '$2', '$3'} .
codeDecl -> '%' iri '%'  : {code, '$2', nil} .
